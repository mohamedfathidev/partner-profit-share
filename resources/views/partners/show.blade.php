...
@section('title')
    الملف الشخصي للشريك {{ $partner->name }}
@stop
...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <p class="mb-0" style="font-weight:bold; font-size:26px;">الملف الشخصي للشريك</p>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}" class="default-color">الرئيسية</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('partners.index') }}">الشركاء</a></li>
                <li class="breadcrumb-item ">الملف الشخصي للشريك</li>
            </ol>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="show-profit-table" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                @foreach ( $partnerProfits->profitShares as $partnerProfit )
                                <tr>
                                    <th>
                                        {{ $partnerProfit->id }}
                                    </th>
                                    <th>
                                        {{ \Carbon\Carbon::parse($partnerProfit->date)->locale('ar')->translatedFormat('F Y') }}
                                    </th>
                                    <th>
                                        {{ $partnerProfit->profit_share }}
                                    </th>
