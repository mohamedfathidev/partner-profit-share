...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <p class="mb-0" style="font-weight:bold; font-size:26px;">قائمة الشركاء</p>
        </div>
        <div class="col-sm-6">
...
<div class="container-fluid">
    <a href="{{ route('partners.create') }}" class="btn btn-warning">إضافة شريك+ </a>
    <div class="row">
