...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> تعديل المعاملة</h4>
            </div>
            <div class="col-sm-6">
...
@section('content')
    <div class="container-fluid">
        ...
        ">
            ...
            "></span>
            لا تحاول تعديل معاملات لشهر تم توزيع أرباحه
        </h2>
        <div class="row">
            <div class="col-md-12 mb-30">
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        <form action="{{ route('transactions.update', $details->id) }}"  method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="date" class="form-control" id="date"
                                       value="{{ \Carbon\Carbon::parse($details->date)->format('Y-m-d')  }}">
                                @error('date')
                                <p class="alert alert-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="partner-select" name="partner_id"
                                        ...
                                        <option value="{{ $details?->partner_id }}" selected>{{ $details->partner?->name }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="exampleFormControlSelect2"
                                        ...
                                        <option value="withdrawal" @selected( $details->type == 'withdrawal' )>سحب</option>
                                        <option value="deposite" @selected( $details->type == 'deposite' )>إيداع</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlSelect2">ملاحظة</label>
                                    <textarea class="form-control" name="note" rows="3">{{ $details->note }}</textarea>
                                </div>
