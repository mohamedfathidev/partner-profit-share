...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <p class="mb-0" style="font-weight:bold; font-size:26px;">قائمة المعاملات</p>
        </div>
        <div class="col-sm-6">
...
<div class="container-fluid">
    <a href="{{ route('transactions.create') }}" class="btn btn-warning">إضافة معاملة+ </a>
    ...
    <div class="card card-statistics">
        <div class="card-body">
                ...
                <div class="text-center mt-3">
                    ...
                    <a href="{{ route('transactions.index') }}" class="btn btn-secondary btn-lg">إعادة تعيين</a>
                </div>
...
<script>
    $(document).ready(function() {
        window.transactionTable = $('#transactions-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url:'{{ route('transactions.load') }}',
                data: function(data) {
...
<script>
    $(document).ready(function() {
        $('#fromDate').datepicker({
            dateFormat: 'yy-mm-dd',  // Correct format for jQuery UI Datepicker
            minDate: 0,
